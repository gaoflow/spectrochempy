...
Computation times
=================
**00:14.385** total execution time for 10 files **from gettingstarted/examples/gallery/auto_examples_analysis/a_decomposition**:
...
.. container::
   ...
   * - Example
     - Time
     - Mem (MB)
   * - :ref:`sphx_glr_gettingstarted_examples_gallery_auto_examples_analysis_a_decomposition_plot_iris_intro.py` (``plot_iris_intro.py``)
     - 00:04.279
     - 0.0
