...
.. code-block:: pytb
    ...
    Traceback (most recent call last):
      File "/home/runner/work/spectrochempy/spectrochempy/build/~gallery_examples/plugins/spectrochempy-nmr/plot_spectrochempy_nmr__processing__apodization__plot_proc_sp.py", line 32, in <module>
        dataset1D /= dataset1D.real.data.max()  # normalize
                     ^^^^^^^^^^^^^^
