...
Computation times
=================
**00:00.097** total execution time for 4 files **from gettingstarted/examples/gallery/auto_examples_processing/nmr**:
...
.. container::
   ...
   * - :ref:`sphx_glr_gettingstarted_examples_gallery_auto_examples_processing_nmr_plot_processing_nmr_relax.py` (``plot_processing_nmr_relax.py``)
     - 00:00.010
     - 0.0
   * - :ref:`sphx_glr_gettingstarted_examples_gallery_auto_examples_processing_nmr_plot_read_nmr_topspin.py` (``plot_read_nmr_topspin.py``)
     - 00:00.009
     - 0.0
