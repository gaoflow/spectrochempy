...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    <Axes: title={'center': 'original data'}, xlabel='Raman shift $\\mathrm{/\\ \\mathrm{cm}^{-1}}$', ylabel='Counts $\\mathrm{}$'>
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    <Axes: title={'center': 'denoised data'}, xlabel='Raman shift $\\mathrm{/\\ \\mathrm{cm}^{-1}}$', ylabel='Counts $\\mathrm{}$'>
